...
5. Use the ```new_conversation``` to force the agent to create a new conversation. If a current conversation does not exist foר the provided ```from_id``` then this property will be ignored  
