...
5. Use the ```new_conversation``` to force the agent to create a new conversation. If a current conversation does not exist fo the provided ``from_id``` this input will be ignored  
